...
} from "./chunk-MCLMKKNZ.js";
import {
  require_node_https
} from "./chunk-F4TIXVLJ.js";
import {
  require_node_module,
  require_node_url
} from "./chunk-W2HCTAJS.js";
import {
  require_url
} from "./chunk-QEVVOOHT.js";
import {
  require_events,
  require_node_os,
  require_os,
...
import {
  ...
  require_promises,
  require_tty
} from "./chunk-DYR4PHGZ.js";
import {
  require_node_path
} from "./chunk-6J7XC4CS.js";
import {
  require_fs
} from "./chunk-IBADHPG3.js";
import {
  require_path
} from "./chunk-5JBJSIMK.js";
import {
  require_node_http
} from "./chunk-BDHL5FV5.js";
import {
  __publicField,
  __toESM
...
var ModuleCacheMap = class extends Map {
  ...
  getSourceMap(moduleId) {
    ...
    if (!mod.meta || !("code" in mod.meta))
      return null;
    const mapString = (_a = mod.meta.code.match(VITE_RUNTIME_SOURCEMAPPING_REGEXP)) == null ? void 0 : _a[1];
    if (!mapString)
      return null;
...
var HMRClient = class {
  constructor(logger, connection, importUpdatedModule) {
    ...
    __publicField(this, "importUpdatedModule");
...
function analyzeImportedModDifference(mod, rawId, moduleType, metadata) {
  var _a;
  if (!(metadata == null ? void 0 : metadata.isDynamicImport) && moduleType !== "module" && ((_a = metadata == null ? void 0 : metadata.importedNames) == null ? void 0 : _a.length)) {
...
function proxyGuardOnlyEsm(mod, rawId, metadata) {
  var _a;
  return ((_a = metadata == null ? void 0 : metadata.importedNames) == null ? void 0 : _a.length) ? new Proxy(mod, {
    get(mod2, prop) {
...
function mapSourcePosition(position) {
  ...
  if (sourceMap && sourceMap.map && sourceMap.url) {
    ...
    if (originalPosition && originalPosition.source != null)
      return originalPosition.source = supportRelativeURL(sourceMap.url, originalPosition.source), sourceMap.vite && (originalPosition._vite = true), originalPosition;
  }
  return position;
}
...
var ViteRuntime = class {
  constructor(options, runner, debug) {
    ...
    this.options = options, this.runner = runner, this.debug = debug, this.moduleCache = options.moduleCache ?? new ModuleCacheMap(options.root), typeof options.hmr == "object" && (this.hmrClient = new HMRClient(options.hmr.logger === false ? silentConsole : options.hmr.logger || console, options.hmr.connection, ({ acceptedPath, ssrInvalidates }) => (this.moduleCache.invalidate(acceptedPath), ssrInvalidates && this.invalidateFiles(ssrInvalidates), this.executeUrl(acceptedPath))), options.hmr.connection.onUpdate(createHMRHandler(this))), options.sourcemapInterceptor !== false && (this._resetSourceMapSupport = enableSourceMapSupport(this));
  }
  /**
